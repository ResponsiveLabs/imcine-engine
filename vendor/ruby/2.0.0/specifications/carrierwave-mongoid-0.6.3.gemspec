# -*- encoding: utf-8 -*-
# stub: carrierwave-mongoid 0.6.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<carrierwave>, ["< 0.10.0", ">= 0.8.0"])
      s.add_runtime_dependency(%q<mongoid>, ["< 5.0", ">= 3.0"])
      s.add_runtime_dependency(%q<mongoid-grid_fs>, ["~> 1.3"])
      s.add_development_dependency(%q<rspec>, ["~> 2.14"])
      s.add_development_dependency(%q<rake>, ["~> 10.0"])
      s.add_development_dependency(%q<mini_magick>, [">= 0"])
      s.add_development_dependency(%q<pry>, [">= 0"])
    else
      s.add_dependency(%q<carrierwave>, ["< 0.10.0", ">= 0.8.0"])
      s.add_dependency(%q<mongoid>, ["< 5.0", ">= 3.0"])
      s.add_dependency(%q<mongoid-grid_fs>, ["~> 1.3"])
